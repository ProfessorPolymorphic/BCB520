...
people<-read_xlsx("Networksfixed.xlsx", sheet = "People")
relations<-read_xlsx("Networksfixed.xlsx", sheet ="Relations")
...
1.  Updating the data in this [file](https://vandalsuidaho-my.sharepoint.com/:f:/g/personal/brobison_uidaho_edu/Eldprmrl8ZhOgAOHGKoRTHYBfa64MS3MH4UWs4tforEZWw?e=wcoLWN).
2.  Coloring the edges according to Advisor / BCB520 attribute.
3.  Coloring the nodes according to Department.
4.  Adujsting the labels to improve readability.
5.  Find the best layout you can for this garbage.  What a nightmare.
6.  Create a network from the edge list data.
7.  Try making a hierarchical network from the org chart data.
